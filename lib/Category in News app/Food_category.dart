...
class Food extends StatefulWidget { // for showing Entertainment Category in our App

  String Query; // query variable
  Food({required this.Query}); // making Category constructor for taking query
  @override
...
class _FoodState extends State<Food> {
  ...
  getNewsByQuery(String query) async {
    ...
    String url = "https://newsapi.org/v2/everything?q=food%20%20and%20Recipe%20latest&SortBy=Hindi&sortBy=Latest%20and%20latest&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa"; // for taking url according to query
    if(query == "Top News" ){ // for showing news belong to this category section
