...
class Category extends StatefulWidget { // for showing different Category in our App

  String Query; // query variable
  Category({required this.Query}); // making Category constructor for taking query
  @override
...
class _CategoryState extends State<Category> {
  ...
  getNewsByQuery(String query) async {
    ...
    String url = "https://newsapi.org/v2/everything?q=indiatimes&sortBy=publishedAt&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa"; // for taking url according to query
