...
class Stocks extends StatefulWidget { // for showing Entertainment Category in our App

  String Query; // query variable
  Stocks({required this.Query}); // making Category constructor for taking query
  @override
...
class _StocksState extends State<Stocks> {
  ...
  getNewsByQuery(String query) async {
    ...
    String url = "https://newsapi.org/v2/everything?q=stocks%20latest&sortBy=Latest%20and%20latest&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa"; // for taking url according to query
