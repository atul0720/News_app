...
class Technology extends StatefulWidget { // for showing Entertainment Category in our App

  String Query; // query variable
  Technology({required this.Query}); // making Category constructor for taking query
  @override
...
class _TechnologyState extends State<Technology> {
  ...
  getNewsByQuery(String query) async {
    ...
    String url = "https://newsapi.org/v2/everything?q=Technology%20latest&sortBy=Latest%20and%20latest&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa"; // for taking url according to query
