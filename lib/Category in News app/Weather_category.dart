...
class Weather extends StatefulWidget { // for showing Entertainment Category in our App

  String Query; // query variable
  Weather({required this.Query}); // making Category constructor for taking query
  @override
...
class _WeatherState extends State<Weather> {
  ...
  getNewsByQuery(String query) async {
    ...
    String url = "https://newsapi.org/v2/everything?q=Weather%20india&sortBy=publishedAt&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa"; // for taking url according to query
