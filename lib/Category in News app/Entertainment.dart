...
class  Entertainment extends StatefulWidget { // for showing Entertainment Category in our App

  String Query; // query variable
  Entertainment({required this.Query}); // making Category constructor for taking query
  @override
...
class _EntertainmentState extends State<Entertainment> {
  ...
  getNewsByQuery(String query) async {
    ...
    String url = "https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa"; // for taking url according to query
    ...
    }else if(query == "Business" || query == " Finance "){
      String url = "https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa";
    }else if(query == "Entertainment" ){ // for showing news belong to Business category category section
      String url = // for showing top news using news API Url
          "https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa";
    }else if(query == "Health" ){ // for showing news belong to Business category category section
      String url = // for showing top news using news API Url
          "https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa";
    }else if(query == "Science" ){ // for showing news belong to Business category category section
      String url = // for showing top news using news API Url
          "https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa";
    }else if(query == "Sports" ){ // for showing news belong to Business category category section
      String url = // for showing top news using news API Url
          "https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa";
    }else if(query == "Technology" ){ // for showing news belong to Business category category section
      String url = // for showing top news using news API Url
          "https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa";
    }else if(query == "Food" ){ // for showing news belong to Business category category section
      String url = // for showing top news using news API Url
          "https://newsapi.org/v2/everything?q=Food&sortBy=publishedAt&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa";
    }else if(query == "Weather" ){ // for showing news belong to Business category category section
      String url = // for showing top news using news API Url
          "https://newsapi.org/v2/everything?q=Weather&sortBy=publishedAt&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa";
    }else if(query == "Travel" ){ // for showing news belong to Business category category section
      String url = // for showing top news using news API Url
          "https://newsapi.org/v2/everything?q=Travel&sortBy=publishedAt&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa";
    }else if(query == "Stock" ){ // for showing news belong to Business category category section
      String url = // for showing top news using news API Url
          "https://newsapi.org/v2/everything?q=Stock&sortBy=publishedAt&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa";
    }else if(query == "CryptoCurrency" ){ // for showing news belong to Business category category section
      String url = // for showing top news using news API Url
          "https://newsapi.org/v2/everything?q=CryptoCurrency&sortBy=publishedAt&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa";
    }
    else{
      String url = "https://newsapi.org/v2/everything?q=news&sortBy=publishedAt&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa";
    }
