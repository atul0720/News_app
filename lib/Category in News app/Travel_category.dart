...
class Travel extends StatefulWidget { // for showing Entertainment Category in our App

  String Query; // query variable
  Travel({required this.Query}); // making Category constructor for taking query
  @override
...
class _TravelState extends State<Travel> {
  ...
  getNewsByQuery(String query) async {
    ...
    String url = "https://newsapi.org/v2/everything?q=Travel&sortBy=publishedAt&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa"; // for taking url according to query
