...
class Business extends StatefulWidget { // for showing Entertainment Category in our App

  String Query; // query variable
  Business({required this.Query}); // making Category constructor for taking query
  @override
...
class _BusinessState extends State<Business> {
  ...
  getNewsByQuery(String query) async {
    ...
    String url = "https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=6e6c0f04acc04e59bf23aaea51c1fafa"; // for taking url according to query
